...
func easyjson783c1624DecodeGithubComBombergameMultiplayerServiceGameObjectsWalls(in *jlexer.Lexer, out *MessageData) {
...
func easyjson783c1624EncodeGithubComBombergameMultiplayerServiceGameObjectsWalls(out *jwriter.Writer, in MessageData) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v MessageData) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson783c1624EncodeGithubComBombergameMultiplayerServiceGameObjectsWalls(&w, v)
...
func (v *MessageData) UnmarshalJSON(data []byte) error {
	...
	easyjson783c1624DecodeGithubComBombergameMultiplayerServiceGameObjectsWalls(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *MessageData) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson783c1624DecodeGithubComBombergameMultiplayerServiceGameObjectsWalls(l, v)
}
